...
namespace O2S_MedicalRecord.DAL
{
    internal static class KetNoiSCDLProcess
    {
        ...
        private static bool CreateTableTblUpdateKhaDung()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTableTblUpdateKhaDung" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblServiceFull()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTableTblServiceFull" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableColumeBackupDichVu()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTableColumeBackupDichVu" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblDVKTBHYTChenh()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTableTblDVKTBHYTChenh" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblDVKTBHYTChenhNew()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTableTblDVKTBHYTChenhNew" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTable_DangDT_Tmp()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTable_DangDT_Tmp" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTable_RaVienChuaTT_Tmp()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTable_RaVienChuaTT_Tmp" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTable_RaVienDaTT_Tmp()
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi CreateTable_RaVienDaTT_Tmp" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool UpdateTableUser()
        {
            ...
            try
            {
                ...
                {
                    O2S_MedicalRecord.Base.Logging.Error("Đã tồn tại cột userhisid trong mrd_tbluser" + ex.ToString());
                    throw;
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi UpdateTableWithVersion" + ex.ToString());
            }
            return result;
        }
        #endregion
        ...
        private static bool CreateView_VienphiMoney() //View v4.8 ngay 15/3/2017
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi tao VIEW vienphi_money" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateView_ServicepriceDepartment() //v4.1
        {
            ...
            {
                O2S_MedicalRecord.Base.Logging.Error("Lỗi tao VIEW serviceprice_department" + ex.ToString());
            }
            return result;
        }
