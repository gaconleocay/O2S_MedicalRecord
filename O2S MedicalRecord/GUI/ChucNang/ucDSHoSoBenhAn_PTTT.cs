...
using O2S_MedicalRecord.GUI.ChucNang.HSBA_PTTT;
...
namespace O2S_MedicalRecord.GUI.ChucNang
{
    public partial class ucDSHoSoBenhAn : UserControl
    {
        ...
        #region Load
        private void ucDSHoSoBenhAn_PTTT_Load(MedicalrecordDTO rowMecicalrecord)
        {
            try
            {
        ...
        private void ClickSelectRow_ChiTietPTTT()
        {
            try
            {
                ...
                if (hienthiform == 1)
                {
                    ...
                    mrdptttserviceDTO.patientid = this.SelectRowMedicalrecord.patientid;
                    mrdptttserviceDTO.vienphiid = this.SelectRowMedicalrecord.vienphiid;
                    mrdptttserviceDTO.hosobenhanid = this.SelectRowMedicalrecord.hosobenhanid;
                    mrdptttserviceDTO.departmentgroupid = this.SelectRowMedicalrecord.departmentgroupid;
                    mrdptttserviceDTO.departmentid = this.SelectRowMedicalrecord.departmentid;
