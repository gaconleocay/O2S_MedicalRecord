            ...
            try
            {
                if (rowMecicalrecord.medicalrecordid != 0 && rowMecicalrecord.hosobenhanid != 0)
                {
                    ...
                    if (dataThongTin.Count > 0)
                    {
                        ...
                        //
                        this.SelectRowMedicalrecord.departmentname = dataThongTin[0]["departmentname"].ToString(); ;
                        this.SelectRowMedicalrecord.departmentgroupname = dataThongTin[0]["departmentgroupname"].ToString();
                        this.SelectRowMedicalrecord.giuong = dataThongTin[0]["giuong"].ToString();
