    ...
    public partial class frmThayPass : Form
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string en_txtUserID = O2S_MedicalRecord.Base.EncryptAndDecrypt.Encrypt(SessionLogin.SessionUsercode, true);
                    string en_txtUserPasswordOld = O2S_MedicalRecord.Base.EncryptAndDecrypt.Encrypt(txtPasswordOld.Text.Trim(), true);
                    string en_txtUserPasswordNew = O2S_MedicalRecord.Base.EncryptAndDecrypt.Encrypt(txtPasswordNew1.Text.Trim(), true);
