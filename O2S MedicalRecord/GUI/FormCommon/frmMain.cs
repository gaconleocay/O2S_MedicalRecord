...
namespace O2S_MedicalRecord.GUI.FormCommon
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            {
                timerClock.Start();
                timerKiemTraLicense.Interval = O2S_MedicalRecord.Base.KeyTrongPhanMem.ThoiGianKiemTraLicense;
        ...
        private void LoadPageMenu()
        {
            try
            {
                ...
                O2S_MedicalRecord.GUI.FormCommon.ucTrangChu ucTrangChu = new FormCommon.ucTrangChu();
