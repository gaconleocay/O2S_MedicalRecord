...
namespace O2S_MedicalRecord.DTO
{
    public class MrdPtttServiceDTO
    {
        ...
        public long mrd_pttttemid { get; set; }
        public long departmentgroupid { get; set; }
        public long departmentid { get; set; }
        public string mrd_pttt_servicedata { get; set; }
        public string mrd_pttt_servicedata_nd { get; set; }
        public long mrd_pttt_servicestatus { get; set; }
