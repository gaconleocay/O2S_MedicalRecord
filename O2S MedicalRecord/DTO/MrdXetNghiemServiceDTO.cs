...
{
    public class MrdXetNghiemServiceDTO
    {
        public long mrd_xn_serviceid { get; set; }
        ...
        public long mrd_xntemid { get; set; }
        public long departmentgroupid { get; set; }
        public long departmentid { get; set; }
        public string mrd_xn_servicedata { get; set; }
        public string mrd_xn_servicedata_nd { get; set; }
        public long mrd_xn_servicestatus { get; set; }
