...
namespace O2S_MedicalRecord.BUS
{
    internal static class TabControlProcess
    {
        ...
        internal static void KiemTraGioiHanSLTabpage(XtraTabControl tabControlName)
        {
            try
            {
                if (tabControlName.TabPages.Count >= O2S_MedicalRecord.Base.KeyTrongPhanMem.SoLuongTabPageChucNang)
                {
                    for (int i = 1; i < tabControlName.TabPages.Count - (O2S_MedicalRecord.Base.KeyTrongPhanMem.SoLuongTabPageChucNang - 1); i++)
                    {
