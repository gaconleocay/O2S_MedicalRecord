...
namespace MSO2_MedicalRecord.GUI.FormCommon.TabCaiDat
{
    ...
    {
        private MSO2_MedicalRecord.DAL.ConnectDatabase condb = new MSO2_MedicalRecord.DAL.ConnectDatabase();
        private string currentUserCode;
        private List<MSO2_MedicalRecord.DTO.classPermission> lstPer { get; set; }
        private List<MSO2_MedicalRecord.DTO.classUserDepartment> lstUserDepartment { get; set; }
        private List<MSO2_MedicalRecord.DTO.classPermission> lstPerBaoCao { get; set; }
        private List<MSO2_MedicalRecord.DTO.classUserMedicineStore> lstUserMedicineStore { get; set; }
        private List<MSO2_MedicalRecord.DTO.classUserMedicinePhongLuu> lstUserMedicinePhongLuu { get; set; }
        ...
        private void LoadDanhSachNguoiDung()
        {
            try
            {
                ...
                {
                    MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao frmthongbao = new MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao(MSO2_MedicalRecord.Base.ThongBaoLable.KHONG_CO_DU_LIEU);
                    frmthongbao.Show();
                }
            }
            catch (Exception ex)
        ...
        private void btnUserOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (currentUserCode == null)//them moi
                {
                    ...
                    MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao frmthongbao = new MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao(MSO2_MedicalRecord.Base.ThongBaoLable.THEM_MOI_THANH_CONG);
                    frmthongbao.Show();
                    LoadDanhSachNguoiDung();
                }
                else //Update 
                {
                    ...
                    MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao frmthongbao = new MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao(MSO2_MedicalRecord.Base.ThongBaoLable.CAP_NHAT_THANH_CONG);
                    frmthongbao.Show();
                }
            }
            catch (Exception ex)
        ...
        void itemXoaNguoiDung_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    ...
                    MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao frmthongbao = new MSO2_MedicalRecord.Utilities.ThongBao.frmThongBao("Đã xóa bỏ tài khoản: " + currentUserCode);
                    frmthongbao.Show();
