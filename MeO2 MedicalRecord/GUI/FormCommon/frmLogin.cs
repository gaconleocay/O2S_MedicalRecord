    ...
    public partial class frmLogin : Form
    {
        ...
        private void KiemTraInsertMayTram()
        {
            try
            {
                ...
                //string tenmay = MSO2_MedicalRecord.GUI.FormCommon.DangKyBanQuyen.HardwareInfo.GetComputerName();
                ...
                {
                    //Kiem tra license
                    //MSO2_MedicalRecord.GUI.FormCommon.DangKyBanQuyen.kiemTraLicenseHopLe.KiemTraLicenseHopLe();
                }
                else
                {
